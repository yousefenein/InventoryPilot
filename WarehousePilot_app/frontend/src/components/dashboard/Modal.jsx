    ...
    <div
            ...
            <div class="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
                ...
                <div class="my-8 text-center">
                    ...
                    <h4 class="text-xl text-gray-800 font-semibold mt-4">{header}</h4>
                    <p class="text-sm text-gray-500 leading-relaxed mt-4">{body}</p>
                </div>
                <div className="flex justify-center  ">
                <Link to={LinkTo}
                 className="px-5 py-2.5 w-full rounded-lg text-white text-sm border-none outline-none bg-gray-800 hover:bg-gray-700 text-center " 
                >
                Got it
                </Link>
