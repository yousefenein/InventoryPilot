    ...
    <div
            ...
            <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
                ...
                <div className="flex justify-center">
                    <button onClick={handleButtonClick} className="px-5 py-2.5 w-full rounded-lg text-white text-sm border-none outline-none bg-gray-800 hover:bg-gray-700 text-center">
                        Close
                    </button>
                </div>
            </div>
