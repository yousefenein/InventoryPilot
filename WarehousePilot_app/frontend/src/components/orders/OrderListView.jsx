        ...
        return (
          <div className="flex items-center gap-2">
            <Chip color="default" variant="flat">
              <span
                className={`flex items-center gap-1 px-2 py-1 rounded ${item.status === "In Progress" ? "text-blue-800" : ""
                  }`}
              >
            ...
            <div className="flex flex-col">
              <div className="flex flex-row justify-between items-center gap-11 p-2">
                ...
                <Chip
                  ...
                  classNames={{
                    base: "text-md border-small border-white/50 w-40 p-2 justify-item-center bg-gray-200", 
                    content: "drop-shadow text-gray-800", 
                  }}
                >
