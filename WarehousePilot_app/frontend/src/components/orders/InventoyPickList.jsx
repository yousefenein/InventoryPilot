...
const InventoryPickList = () => {
  ...
  return (
    <div className='bg-whitedark:bg-[#111827]'>
      <div className={`mt-16 p-8  ${theme === "dark" ? "dark" : ""}`}>
        ...
        {loading ? (
          ...
          <>
            <Table
              ...
              className="min-w-full bg-white dark:bg-transparent"
              isHeaderSticky
          ...
          <ModalContent>
            <div className="p-4">
              ...
              <Input
                ...
                className="mb-3 bg-white dark:bg-gray-800 dark:text-white"
              />
              <Select
                label="Assign Staff"
