...
const Sidebar = ({ isOpen }) => {
  ...
  return (
    <aside
      className={`fixed top-0 left-0 z-40 w-64 h-screen pt-5 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 sm:translate-x-0 ${
        ...
        <ul className="space-y-2 font-medium text-base">
          ...
          <li>
            ...
            >
              {/* SVG Icon */}
              <svg
                className="w-5 h-5 mr-2 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                aria-hidden="true"
          ...
          <li>
            {isOpen && (
              <div className="relative flex justify-center items-center mx-auto">
                {/* Renders user avatar if userData is available */}
